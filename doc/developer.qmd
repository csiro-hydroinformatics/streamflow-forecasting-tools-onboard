...
The streamflow forecasting software stack comprise a dozen or so public or private `git` repositories. Co-evloving these repositories is not trivial. Each component may have a versioning rationale that is orthogonal to others. However for reproducibility we need to have "meta-releases" that are aggregates of components with a clear, traceable lineage.
