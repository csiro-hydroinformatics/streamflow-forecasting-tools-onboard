...
This is only a basic workflow for illustrative purposes, not an extensive reference document. Much work was done by the Matlab user base, but not (yet) published for an external audience.
